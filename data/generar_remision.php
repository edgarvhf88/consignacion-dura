...
if (isset($_POST['id_pedido'])){
	...
	RemisionarPedido($id_pedido);
	
}
function RemisionarPedido($id_pedido){
...
$clave_cliente = "STAR0";
$vendedor_id = 0;  //// CREAR UN VENDEDOR TOOLCRIB 
$cond_pago_id = 219; // 30 dias de credito para 0 dias = 209
$dir_cli_id = 909; // direccion 
$dir_consig_id = 909; // direccion
$moneda_id = 1; // MXN
$tipo_docto = "R";
$folio = ObtenerFolio();
$folio_cosecutivo = $folio;
$estatus = "P";
$total_impuestos = $row_pedido['total_pedido'] * .08;
$sistema_origen = "VE";
$tipo_dscto = "P";
...
$importe_neto = $row_pedido['total_pedido'];
...
{  //// AL TENER EXITO LA INSERCION DEL DOCUMENTO REMISION ENTONCES SE APLICA LAS SIGUIENTES INSERCIONES 
	...
	$consulta_articulos = "SELECT pd.clave_microsip as clave, pd.cantidad as cantidad, pd.precio_unitario as precio_unitario, pd.precio_total as precio_total, a.id_microsip as id_microsip  
							FROM pedidos_det pd 
