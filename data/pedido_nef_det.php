...
$consulta_lista = "SELECT a.clave_microsip as clave_microsip, a.clave_microsip_nef as clave_microsip_nef, pd.id_articulo as id_articulo, pd.articulo as articulo, pd.precio_unitario as precio_unitario, pd.precio_total as precio_total, pd.cantidad as cantidad, p.estatus as estatus
					FROM pedido_nef_det pd
					INNER JOIN pedido_nef p ON p.id_pedido = pd.id_pedido
