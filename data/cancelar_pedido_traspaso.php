...
{ // elimina partidas de orden deompra en captura
	global $database_conexion, $conex;
			$sql_pos = "SELECT * FROM pedido_traspaso 
			...
			if ($total_respos > 0) // 
			{
				...
				$delete_partida = "DELETE FROM pedido_traspaso_det WHERE id_pedido = $id_pedido ";
				if (mysql_query($delete_partida, $conex) or die(mysql_error()))
				{	
					$delete_ped = "DELETE FROM pedido_traspaso WHERE id_pedido = $id_pedido ";
