<?php include("conexion.php");
	  ...
	  if ($id_pedido != ''){
			...
			guardar_carrito($id_pedido);
	  }
     function guardar_carrito($id_pedido){ // cambia el estatus del pedido a 0p para indicar que se quedara pendiente y continuar con un pedido nuevo aparte, para posteriormente continuar con el pedido o los pedidos guardados
