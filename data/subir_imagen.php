...
{		
	...
	$carpeta = "../inv_docs/imagenes/"; 
	$src_mostrar = "inv_docs/imagenes/"; // es diferente la ruta por que donde se muestra es en la ruta raiz
	...
	<script> guardar_registro_imagen("'.$nombre.'");</script>';
